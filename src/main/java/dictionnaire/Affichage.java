...
public abstract class Affichage {
    public final static void afficherActions() {
        ...
        System.out.println("Pour afficher la liste des mots présents dans le dictionnaire, vous pouvez taper 1. Tapez 2 pour enregistrer la liste de mots et taper un mot pour connaitre sa définition.");
        System.out.println("Enfin, vous pouvez taper 'stop' lorsque vous souhaitez arrêter le programme.");
        System.out.print("Quel est votre choix ? (1, 2, mot ou stop) : ");
